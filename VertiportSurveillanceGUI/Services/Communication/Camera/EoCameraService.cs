...
namespace VertiportSurveillanceGUI.Services.Camera
{
    /// <summary>
    /// [EO] [Camera] 영상 서비스
    /// 
            ...
            string rtspAddress)
        {
            ...
            try
            {
                ...
                if (!isOpen)
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("[EO VIDEO] RTSP Open Failed");
                ...
                Console.WriteLine("[EO VIDEO] RTSP Open Success");
                ConsoleLogHelper.PrintLine();
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("[EO VIDEO ERROR] " + ex.Message);
                ConsoleLogHelper.PrintLine();
            }
            finally
            {
